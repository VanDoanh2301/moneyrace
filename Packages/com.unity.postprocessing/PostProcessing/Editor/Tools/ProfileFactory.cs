...
namespace UnityEditor.Rendering.PostProcessing
{
    ...
    {
        // NOTE: the stock "Assets/Create/Post-processing Profile" menu item used EndNameEditAction,
        // which is an error-level obsolete API on this Unity version and breaks the whole assembly's
        // compilation. Disabled since profiles are created via ProfileFactory.CreatePostProcessProfileAtPath
        // directly by project tooling instead of this menu.
        /*
