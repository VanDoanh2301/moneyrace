...
namespace TapTap
{
    ...
    /// Port từ moneyrace-skybranch; coin được cộng vào <see cref="CoinWallet"/>.
    /// </summary>
    public class IAPManager : MonoBehaviour, IDetailedStoreListener
    {
        ...
        [Tooltip("false = NonConsumable (giống game mẫu: sản phẩm 'tính phí một lần' trên Play Console, mỗi tài khoản chỉ mua được 1 lần).\n" +
