...
namespace TapTapEditor
{
    ...
    /// kèm menu item để thêm thủ công. Port từ moneyrace-skybranch.
    /// </summary>
    public static class AddIAPManagerToScene
    {
        ...
        [MenuItem("Tools/TapTap/Add IAPManager to Gameplay Scene")]
        public static void AddIAPManagerToGameplay()
        {
            AddIAPManagerToSceneAtPath(GameplayScenePath);
        }

        [MenuItem("Tools/TapTap/Add IAPManager to Current Scene")]
        ...
        /// <summary>Dò cả trong con, không chỉ root (bản mẫu chỉ dò root nên dễ tạo trùng).</summary>
